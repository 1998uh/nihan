...
export default {
        ...
        methods: {
            ...
            detach() {
                ...
                let havaChild=targetCurrent.filter(item=>Object.prototype.hasOwnProperty.call(item, 'children'))
                let noChild=targetCurrent.filter(item=>Object.prototype.hasOwnProperty.call(item, 'children'))
               ...
               if (sourceCurrent.length > 0) {
                 ...
                 if(!this.isOnly){
                     sourceCurrent.forEach(item => {
                         ...
                         if(Object.prototype.hasOwnProperty.call(newItem, 'children'))  haveChild.push(newItem);
